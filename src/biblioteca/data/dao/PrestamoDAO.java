...
public class PrestamoDAO implements DAO<Prestamo> {
    ...
    public void insertar(Prestamo p) throws DAOException {
        ...
        try (Connection conn = ConexionBD.getConexion();
            ...
            ps.setString(3, p.getEstado() != null ? p.getEstado() : "Activo");
            ps.setInt(4, p.getDiasPrestamo());
            ps.setInt(5, p.getSocio().getId());
    ...
    public Prestamo buscarPorId(int id) throws DAOException {
        String sql = """
                SELECT
                  ...
                  s.estado AS s_estado, s.tiene_sanciones, s.tiene_atrasos,
                  ...
                  l.id_libro, l.titulo, l.id_autor, l.isbn, l.categoria, l.id_editorial, l.anio_publicacion,
                  b.id_bibliotecario, u_b.nombre AS b_nombre, u_b.apellido AS b_apellido, u_b.dni AS b_dni, u_b.username AS b_username,
                  u_b.password AS b_password, u_b.email AS b_email, u_b.telefono AS b_telefono, u_b.fecha_registro AS b_fecha_registro,
                  b.legajo, b.turno
                FROM Prestamo p
    ...
    public List<Prestamo> listarTodos() throws DAOException {
        String sql = """
                ...
                INNER JOIN Socio s ON p.id_socio = s.id_socio
                INNER JOIN Usuario u_s ON s.id_usuario = u_s.id_usuario
                INNER INNER JOIN Ejemplar e ON p.id_ejemplar = e.id_ejemplar
                INNER JOIN Libro l ON e.id_libro = l.id_libro
                LEFT JOIN Bibliotecario b ON p.id_bibliotecario = b.id_bibliotecario
                LEFT JOIN Usuario u_b ON b.id_usuario = u_b.id_usuario
    ...
    // listarPorSocio() y listarPorISBN()
    public List<Prestamo> listarPorSocio(int idSocio) throws DAOException {
        String sql = """
            SELECT
              p.id_prestamo, p.fecha_prestamo, p.fecha_vencimiento, p.estado, p.dias_prestamo,
              s.id_socio, s.id_usuario AS s_id_usuario, s.numero_socio, s.fecha_vencimiento_carnet, 
              s.estado AS s_estado, s.tiene_sanciones, s.tiene_atrasos,
              ...
              e.id_ejemplar, e.codigo_ejemplar, e.estado AS e_estado, e.ubicacion,
              l.id_libro, l.titulo, l.id_autor, l.isbn, l.categoria, l.id_editorial, l.anio_publicacion,
              b.id_bibliotecario, u_b.nombre AS b_nombre, u_b.apellido AS b_apellido, 
    ...
    private Prestamo mapearPrestamo(ResultSet rs) throws SQLException {
        ...
        LocalDate fechaPrestamo = rs.getTimestamp("fecha_prestamo")
                .toInstant()
        ...
        return new Prestamo(id, fechaPrestamo, fechaVencimiento, estado, diasPrestamo, socio, ejemplar, null);
    }
    ...
    private Socio mapearSocio(ResultSet rs) throws SQLException {
        ...
        LocalDate vencCarnet = rs.getDate("fecha_vencimiento_carnet") != null
                ? rs.getDate("fecha_vencimiento_carnet").toLocalDate() : null;
        ...
        return new Socio(idSocio, nombre, apellido, dni, email, telefono, fechaRegistro, tipo,
                username, password, numeroSocio, vencCarnet, estado, sanciones, atrasos);
    }
