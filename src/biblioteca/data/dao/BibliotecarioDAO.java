...
public class BibliotecarioDAO implements DAO<Bibliotecario> {
        ...
        try (Connection conn = ConexionBD.getConexion()) {
            ...
            try {
                ...
                try (PreparedStatement psUsuario = conn.prepareStatement(sqlUsuario, Statement.RETURN_GENERATED_KEYS)) {
                    ...
                    psUsuario.setDate(6, Date.valueOf(b.getFechaAlta()));
                    psUsuario.setString(7, b.getUsuario());
                    psUsuario.setString(8, b.getContrasenia());
                    psUsuario.setString(9, b.getTipoUsuario().toString());
                ...
                // Inserción en Bibliotecario
                try (PreparedStatement psBiblio = conn.prepareStatement(sqlBibliotecario)) {
    ...
    public void actualizar(Bibliotecario b) throws DAOException {
        String sql = """
                ...
                SET u.email = ?, u.telefono = ?, biblio.turno = ?, biblio.legajo = ?
    ...
    /**
     * Mapea un registro SQL a un objeto Bibliotecario.
     */
